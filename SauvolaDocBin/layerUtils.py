...
if __name__ == '__main__':
    layer = DifferenceThresh()
    layer.build(input_shapes=[(None, None, 1), (None, None, 1)])
    data1, data2 = np.full((1, 256, 256, 1), 0.66), np.ones((1, 256, 256, 1))
    output = layer.call([data1, data2])
